...
export interface UserModel {
  ...
  reducers: {
    setUserTasks: ImmerReducer<
      UserModelState,
      ReturnType<typeof createSetUserTasks>
    >;
    setUserHistories: ImmerReducer<
      UserModelState,
      ReturnType<typeof createSetUserHistories>
    >;
  };
}
