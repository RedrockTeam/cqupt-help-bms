    ...
    <div>
      ...
      <div className={sharedStyles.wrapper}>
        <div className={sharedStyles.inputWrapper} style={{ margin: 0 }}>
          <span className={sharedStyles.name}>活动名称</span>{title}
        </div>
        ...
        <div className={sharedStyles.inputWrapper}>
          ...
          />
          <span className={styles.dateTip}>请输入可领取奖品时间，例如：比如9点-11点，14点-17点</span>
        </div>
        <div className={sharedStyles.inputWrapper}>
        ...
        />)}
        <div className={styles.add} onClick={() => dispatch!(createAddPushGiftInput())}>+ 添加该活动其他等级奖品</div>
        <Button
          type="primary"
